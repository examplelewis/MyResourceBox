...
- (instancetype)init {
    self = [super init];
    if (self) {
        NSString *rootPath = @"/Users/mercury/SynologyDrive/~同步文件夹";
...
- (void)organizeAllFetchedTags {
    ...
    NSPredicate *predicate = [NSPredicate predicateWithFormat:@"SELF BEGINSWITH '/Users/mercury/SynologyDrive/~同步文件夹/同步文档/MyResourceBox/Tags/FetchedTags_'"];
